                ...
                <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
                    ...
                    >
                        <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
                            ...
                            <li className='sm:pb-2 xs:pb-2'>
                                <a href="https://open.spotify.com/artist/72cDW9EG2IL2Rdkv25TPBh?si=eiGG0vv7TRGzsgn-wcisUQ&dl_branch=1" target='_blank' rel='nooopener noreferrer' className='text-white flex flex-row'>
                                    ...
                                    <p className='px-2'>listen</p>
                                </a>
                            </li>
                            <li className='sm:pb-2 xs:pb-2'>
                                <a href="https://www.tiktok.com/@hunterdeblanc?" target='_blank' rel='nooopener noreferrer' className='text-white flex flex-row'>
