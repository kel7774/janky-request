                ...
                <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
                    ...
                    >
                        <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
                            ...
                            <li className='sm:pb-2 xs:pb-2'>
                                <a href="https://www.instagram.com/jankypianoshow " target='_blank' rel='nooopener noreferrer' className='text-white flex flex-row'>
                            ...
                            <li className='sm:pb-2 xs:pb-2'>
                                <a href="https://www.youtube.com/playlist?list=PLNL0AM07NLoPWxNMHfEtSCGA5dt9UXwkb" target='_blank' rel='nooopener noreferrer' className='text-white flex flex-row'>
