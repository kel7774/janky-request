        ...
        <footer className='w-full h-16 bg-jazzPurple'>
            <div className='flex flex-row justify-between text-indigo-50 font-medium px-20 py-4'>
                <section className='font-medium'>
                    <a href='https://github.com/kel7774' target='_blank' rel='noreferrer' className='flex flex-row font-bold hover:underline'>
                        ...
                        &nbsp;code by kelli landry</a></section>
                <section className='font-medium'>
                    <a href="https://thegrouseroom.com/" target='_blank' rel='noreferrer' className='flex flex-row font-bold hover:underline'>
